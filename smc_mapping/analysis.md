...
| ftPk | flt | +29.06 | yes |  |
| Tp3a | flt | +28.97 | yes | CPU performance core |

## Top responders to `cpu_e`
...
| PDTR | flt | +15.87 |  |  |
| fpC0 | flt | +15.13 |  |  |
| PSTR | flt | +14.97 |  | system total power |
| si10 | flt | +14.00 |  |  |
| PHPC | flt | +13.83 |  |  |
| si01 | flt | +13.80 |  |  |
| PHPS | flt | +13.78 |  |  |
| PZC0 | flt | +13.78 |  | CPU cluster power |
| PZC1 | flt | +13.53 |  | CPU cluster power |
| fdS0 | flt | +13.29 |  |  |
| fph0 | flt | +12.83 |  |  |

## Top responders to `disk`
...
| si05 | flt | +5.78 |  |  |
| PDTR | flt | +5.78 |  |  |
| TH0a | flt | +5.76 | yes | NAND / storage |
| TH0x | flt | +5.62 | yes | NAND / storage |
| TH0b | flt | +5.25 | yes | NAND / storage |
| PHPC | flt | +3.45 |  |  |
| si10 | flt | +3.45 |  |  |
| Tg1t | flt | +3.09 |  | GPU |
| Tg1F | flt | +3.08 |  | GPU |
...
| Tp3a | flt | cpu_all | +28.97 | CPU performance core |
| ftPe | flt | cpu_all | +28.74 |  |
| Tp3i | flt | cpu_all | +27.85 | CPU performance core |
| Tp1Q | flt | cpu_all | +27.72 | CPU performance core |
| Tp1R | flt | cpu_all | +27.72 | CPU performance core |
| ftPg | flt | cpu_all | +27.59 |  |
| ftP6 | flt | cpu_all | +27.53 |  |
| ftPi | flt | cpu_all | +27.13 |  |
| Tp3W | flt | cpu_all | +26.78 | CPU performance core |
| Tp0U | flt | cpu_all | +26.52 | CPU performance core |
| Tp0V | flt | cpu_all | +26.52 | CPU performance core |
| ftP0 | flt | cpu_all | +26.36 |  |
| mlS2 | flt | memory | +25.78 |  |
| ftPm | flt | cpu_all | +25.75 |  |
| Tp34 | flt | cpu_all | +25.68 | CPU performance core |
| Tp33 | flt | cpu_all | +25.68 | CPU performance core |
| B0RM | ui16 | cpu_all | +25.67 |  |
| Tp3O | flt | cpu_all | +25.61 | CPU performance core |
| Tp0a | flt | cpu_all | +25.51 | CPU performance core |
...
| Tp0h | flt | cpu_all | +21.62 | CPU performance core |
| ftP8 | flt | cpu_all | +21.57 |  |
| ftPn | flt | cpu_all | +21.53 |  |
| Tp3D | flt | cpu_all | +21.48 | CPU performance core |
| Tp1p | flt | cpu_all | +21.47 | CPU performance core |
| Tp1o | flt | cpu_all | +21.47 | CPU performance core |
| Tp2B | flt | cpu_all | +21.45 | CPU performance core |
| Tp1x | flt | cpu_all | +21.43 | CPU performance core |
...
| Tp05 | flt | cpu_all | +20.50 | CPU performance core |
| Tp04 | flt | cpu_all | +20.50 | CPU performance core |
| Tp1S | flt | cpu_all | +20.42 | CPU performance core |
| ftP1 | flt | cpu_all | +20.40 |  |
...
| Tp1i | flt | cpu_all | +18.38 | CPU performance core |
| Tp35 | flt | cpu_all | +18.10 | CPU performance core |
| Tp31 | flt | cpu_all | +17.62 | CPU performance core |
| Tp2R | flt | cpu_all | +17.25 | CPU performance core |
| Tp1G | flt | cpu_all | +17.12 | CPU performance core |
| TCMz | flt | cpu_all | +16.98 | CPU die hotspot |
| Tp2t | flt | cpu_all | +16.65 | CPU performance core |
| Tp1q | flt | cpu_all | +16.50 | CPU performance core |
| Tp06 | flt | cpu_all | +16.41 | CPU performance core |
| Tp1z | flt | cpu_all | +16.20 | CPU performance core |
| Tp0i | flt | cpu_all | +15.22 | CPU performance core |
| si12 | flt | cpu_all | +15.21 |  |
...
| Tp2Y | flt | cpu_all | +13.65 | CPU performance core |
| Tp2X | flt | cpu_all | +13.65 | CPU performance core |
| Tp0S | flt | cpu_all | +13.59 | CPU performance core |
...
| Tp27 | flt | cpu_all | +13.09 | CPU performance core |
| ftPa | flt | cpu_all | +13.03 |  |
| Tp2Z | flt | cpu_all | +12.62 | CPU performance core |
| ftE0 | flt | cpu_all | +12.55 |  |
| Te05 | flt | cpu_all | +12.52 | CPU efficiency core |
| Te04 | flt | cpu_all | +12.52 | CPU efficiency core |
| Tf0A | flt | cpu_all | +12.43 |  |
| Te0P | flt | cpu_all | +12.42 | CPU efficiency core |
| Tp0o | flt | cpu_all | +12.37 | CPU performance core |
| Tp0T | flt | cpu_all | +12.37 | CPU performance core |
| vop0 | flt | cpu_all | +12.28 |  |
| IC42 | flt | cpu_all | +12.04 |  |
| ftPr | flt | cpu_all | +12.03 |  |
| Tp3e | flt | cpu_all | +11.98 | CPU performance core |
| Tp2k | flt | cpu_all | +11.97 | CPU performance core |
...
| Ts04 | flt | cpu_all | +11.19 |  |
| Ts0h | flt | cpu_all | +11.10 |  |
| Te06 | flt | cpu_all | +10.95 | CPU efficiency core |
| Te0Q | flt | cpu_all | +10.88 | CPU efficiency core |
| Th05 | flt | cpu_all | +10.87 |  |
| Th04 | flt | cpu_all | +10.87 |  |
| Ts06 | flt | cpu_all | +10.66 |  |
| IC02 | flt | cpu_all | +10.56 |  |
| Ts0i | flt | cpu_all | +10.55 |  |
...
| ftG3 | flt | gpu | +7.66 |  |
| Tf2A | flt | gpu | +7.66 |  |
| Tg22 | flt | gpu | +7.61 | GPU |
| Tg21 | flt | gpu | +7.61 | GPU |
| mlTJ | flt | cpu_e | +7.50 |  |
| ftG7 | flt | gpu | +7.23 |  |
| ceFa | flt | cpu_all | +7.19 |  |
| Tg3y | flt | gpu | +7.18 | GPU |
...
| Tg00 | flt | gpu | +5.95 | GPU |
| si00 | flt | disk | +5.79 |  |
| TH0a | flt | disk | +5.76 | NAND / storage |
| TH0x | flt | disk | +5.62 | NAND / storage |
| PMVC | flt | memory | +5.55 | memory power |
| vof0 | flt | cpu_all | +5.50 |  |
...
| TRD4 | flt | memory | +2.94 |  |
| TRDf | flt | memory | +2.88 |  |
| TRD8 | flt | memory | +2.85 |  |
| TRDa | flt | memory | +2.84 |  |
| TRDX | flt | memory | +2.83 |  |
| TRD1 | flt | memory | +2.80 |  |
| mlTI | flt | cpu_e | +2.78 |  |
| TRDb | flt | memory | +2.76 |  |
...
| TRDc | flt | memory | +2.41 |  |
| ffM0 | flt | memory | +2.39 |  |
| TRD7 | flt | memory | +2.37 |  |
| TRDe | flt | memory | +2.37 |  |
| PPMC | flt | memory | +2.25 |  |
| ftVV | flt | cpu_all | +2.21 |  |
| ftV2 | flt | cpu_all | +2.21 |  |
| TaLW | flt | disk | +2.12 |  |
| si13 | flt | gpu | +2.08 |  |
| iaPh | flt | memory | +2.04 |  |
| mlH0 | flt | memory | +2.04 |  |
| TaTP | flt | memory | +1.95 |  |
| TPD7 | flt | memory | +1.91 | CPU performance core die |
| TPDe | flt | memory | +1.85 | CPU performance core die |
...
| Ib8f | flt | gpu | +1.57 |  |
| TPDd | flt | memory | +1.56 | CPU performance core die |
| TPD8 | flt | memory | +1.54 | CPU performance core die |
| TPD4 | flt | memory | +1.53 | CPU performance core die |
| TPDb | flt | memory | +1.51 | CPU performance core die |
| IMVC | flt | memory | +1.49 |  |
| TPD0 | flt | memory | +1.48 | CPU performance core die |
| IC43 | flt | cpu_all | +1.45 |  |
| TVSO | flt | memory | +1.44 |  |
| PC43 | flt | cpu_all | +1.43 |  |
| IC03 | flt | cpu_all | +1.42 |  |
| PC03 | flt | cpu_all | +1.41 |  |
| IP5b | flt | cpu_all | +1.40 |  |
| TPSP | flt | memory | +1.40 | CPU performance cluster |
| TMVR | flt | memory | +1.39 |  |
| f007 | flt | memory | +1.31 |  |
| TPMP | flt | memory | +1.30 | CPU performance cluster |
| PP5b | flt | cpu_all | +1.27 |  |
| PR2b | flt | memory | +1.22 |  |
| PP2b | flt | memory | +1.22 |  |
| I006 | flt | gpu | +1.20 |  |
| IR2b | flt | memory | +1.20 |  |
| IP2b | flt | memory | +1.19 |  |
| TW0P | flt | memory | +1.15 |  |
| msP2 | flt | cpu_e | +1.14 |  |
| I005 | flt | gpu | +1.11 |  |
| I00A | flt | gpu | +1.03 |  |
...
| TaLT | flt | disk | +0.64 |  |
| IC40 | flt | gpu | +0.62 |  |
| IPMC | flt | memory | +0.61 |  |
| fRmp | flt | cpu_all | +0.61 |  |
| fiB0 | flt | gpu | +0.59 |  |
| ft01 | flt | gpu | +0.58 |  |
| VC12 | flt | gpu | +0.56 |  |
| IP9b | flt | cpu_all | +0.55 |  |
| PP9b | flt | cpu_all | +0.55 |  |
| PC40 | flt | gpu | +0.54 |  |
| IR8b | flt | disk | +0.52 |  |
